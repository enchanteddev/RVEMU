use crate::{decoder::{self, IInstr, Instruction, RInstr, SInstr, UInstr}, memmap};
use std::{
    cell::RefCell,
    collections::HashMap,
    mem::take,
...
impl DynamicMemory {
    ...
    pub fn load(&mut self, addr: u32) -> u8 {
...
pub struct Machine {
    ...
    pub pc: u32,
    pub instructions: Vec<decoder::Instruction>,
...
impl Machine {
    ...
    pub fn load_instructions(&mut self, instructions: Vec<decoder::Instruction>) {
